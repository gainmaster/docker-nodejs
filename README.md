...
[![Build Status](http://jenkins.hesjevik.im/buildStatus/icon?job=docker-nodejs)](http://jenkins.hesjevik.im/job/docker-nodejs/) [![Docker Hub](https://img.shields.io/badge/docker-ready-blue.svg?style=plastic)](https://registry.hub.docker.com/u/bachelorthesis/nodejs)
